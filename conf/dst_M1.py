...
conf = {
    ...
    'end_date': '2027-09-30',
    'outname': '/home/theisen/Code/AFC_Summary/images/dst/dst_M1_data_availability.pdf', #options are png, pdf, etc
    'chart_style': 'linear',
    'info_style': 'simple',
    ...
    'instruments':{
        ...
        #'rwp': {'dsname': '915rwpprecipavghiresM1.a1', 'dsname2': '915rwpwindavghiresM1.a1', 't_delta': 10},
