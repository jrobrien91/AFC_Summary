...
conf = {
    ...
    'instruments':{
        ...
        'mwrhf': {'dsname': 'mwrhfM1.b1', 'data_path': '/data/datastream'},
        'nfov': {'dsname': 'nfov2chM1.b1', 'data_path': '/data/datastream'},
        'rwp': {'dsname': '915rwpwindconX10.a1', 'dsname2': '915rwpprecipconX10.a1', 'data_path': '/data/datastream', 't_delta': 60},
        ...
        'vdis': {'dsname': 'vdisM1.b1', 'data_path': '/data/datastream'},
